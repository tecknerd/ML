# -*- coding: utf-8 -*-
"""
Created on Thu Oct 14 19:09:18 2021
...
class PhysicsInformedNN:
    ...
    def __init__(self, X, u, layers, lb, ub):
       ...
       #self.sess = tf.Session(config=tf.ConfigProto(allow_soft_placement=True,
        ...
        self.alpha_1 = tf.Variable([1.5], dtype=tf.float32)
    ...
    def callback(self, loss, alpha_1):
        print('Loss: %e, l1: %.5f' % (loss, alpha_1))
...
if __name__ == "__main__": 
   ...
   # Exact = np.real(data['usol']).T
    ...
    model = PhysicsInformedNN(X_u_train, u_train, layers, lb, ub)
    model.train(10000)#change this to a small number like 10, just tocheck whether the code is running without any issues.
